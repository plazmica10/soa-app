...
func (r *LikeRepository) ExistsByBlogAndUser(ctx context.Context, blogID, userID primitive.ObjectID) (bool, error) {
	count, err := r.coll.CountDocuments(ctx, bson.M{"blog_id": blogID, "user_id": userID})
	if err != nil {
		return false, err
	}
	return count > 0, nil
